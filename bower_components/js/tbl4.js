...
$sked2.on('event:dragEnded.skedtape', function(e) {
...
//$sked2.skedTape('removeEvent', e.detail.event.id);
});

console.log(today(6, 0));

function newReservation() {
$sked2.skedTape('startAdding', {
    name: 'New meeting',
    location: '1',
    start: today(6, 0),
    end: today(7, 0),
...
$sked2.on('timeline:click.skedtape', function(e, api) {
try {
    newReservation();
} catch (e) {
